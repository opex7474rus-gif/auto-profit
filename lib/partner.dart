...
class PartnerBalance {
  ...
  /// = 0 — всё сошлось.
  ///
  /// Считается так: физические взносы партнёра минус его заборы,
  /// плюс заработанная им прибыль, минус то, что сейчас заморожено
  /// в машинах на складе. Разница — это «свободные» деньги партнёра
  /// в ваших руках (или его долг вам).
  double get balance =>
      manualIn - manualOut + profitShare - inWorkNow;

  /// Свободный остаток партнёра — сколько вы должны ему деньгами.
  /// Если баланс отрицательный, свободного остатка нет.
  double get freeBalance => balance > 0 ? balance : 0;

  /// Долг партнёра перед вами.
  /// Положительное число — он должен вам.
